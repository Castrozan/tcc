...
conhecido como red teaming. Segundo Inie et al.~(2025) (Inie, Stray, and
...
por meio de simples instruções em linguagem natural (Brown et al. 2020).
...
estendidas do GPT-4 suportam até 32.000 tokens (OpenAI 2023b). Esse
...
relevantes) (Anthropic 2024a; OpenAI 2023b).
...
como o function calling da OpenAI (OpenAI 2023a). Essa funcionalidade
...
vez de apenas tentar adivinhar a resposta (OpenAI 2023a).

Complementando essa capacidade, o Model Context Protocol (MCP),
desenvolvido pela Anthropic (Model Context Protocol Team 2025; Anthropic
2024b), oferece um padrão aberto para conectar LLMs a diversas fontes de
dados e ferramentas. O MCP estabelece uma arquitetura cliente-servidor
onde os modelos (clientes) podem acessar servidores MCP que expõem
recursos, prompts e ferramentas de forma padronizada. Isso elimina a
necessidade de integrações personalizadas para cada fonte de dados,
promovendo uma interoperabilidade mais ampla e sustentável.
...
\item
  ...
  (EnterpriseDB 2023b). Além disso, décadas de desenvolvimento ativo e
  ...
  operacional disponível (EnterpriseDB 2023b, 2023a).
\item
  ...
  mais de meio milhão de repositórios que o utilizam (S. Team 2024).
...
Anthropic. 2024a. {``Anthropic Now Offers 100K Context Windows for
Claude 3 Models.''} 2024.
\url{https://www.anthropic.com/news/100k-context-windows}.

\bibitem[\citeproctext]{ref-anthropic2024mcp}
---------. 2024b. {``Model Context Protocol (MCP): A Standard for AI
Context Integration.''} 2024.
\url{https://www.anthropic.com/news/model-context-protocol}.

\bibitem[\citeproctext]{ref-Anthropic2024}
Anthropic. 2024c. {``{Introducing the Model Context Protocol}.''}
Anthropic News.
\url{https://www.anthropic.com/news/model-context-protocol}.
...
Are Few-Shot Learners.''} \url{https://arxiv.org/abs/2005.14165}.
...
EnterpriseDB. 2023a. {``EnterpriseDB Raises the Bar for Postgres
Security and Compliance.''} 2023.
...
---------. 2023b. {``Postgres Is the Most Admired Database in Stack
Overflow 2023 Survey.''} 2023.
...
Model Context Protocol Contributors. 2024. {``{Model Context Protocol
Documentation - Introduction}.''} Online Documentation.
\url{https://modelcontextprotocol.io/introduction}.

\bibitem[\citeproctext]{ref-mcp2025spec}
Model Context Protocol Team. 2025. {``Model Context Protocol
...
Team, EverSQL. 2023. {``Best ORM for Node.js in 2023: A Comprehensive
Comparison.''} 2023.
\url{https://www.eversql.com/best-orm-for-node-js/}.

\bibitem[\citeproctext]{ref-sequelize2024}
Team, Sequelize. 2024. {``Sequelize: A Modern TypeScript and Node.js ORM
...
The Postman Team. 2023. {``{What is OpenAPI?}''} Postman Blog.
